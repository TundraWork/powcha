...
func TestMessageIsValidResponse(t *testing.T) {
	...
	RotateSecrets() // Rotate current secret to the fake random string
	RotateSecrets() // Rotate previous secret to the fake random string

	// Reset random functions to use the real ones
	internal.RandomInt = internal.RandomIntReal
	internal.RandomString = internal.RandomStringReal
